...
示例:
  ./scripts/render-video.sh examples/published/001-llm-wiki-karpathy-zh.md
  ./scripts/render-video.sh examples/published/001-llm-wiki-karpathy-zh.md dist/001-llm-wiki-karpathy-zh.mp4
  npm run video:render -- examples/published/001-llm-wiki-karpathy-zh.md dist/001-llm-wiki-karpathy-zh.mp4
