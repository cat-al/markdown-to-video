...
每个场景包含四个部分：**画面描述**、**视觉元素**、**字幕文案**、**动画指令**。
...
> 第一段字幕文案，对应第一个 step 的完整口播内容，30-80 字

**动画**: 画面变化描述——什么元素入场/退场/高亮/移动，30-100 字

> 第二段字幕文案，对应第二个 step 的完整口播内容

**动画**: 画面变化描述

> 第三段字幕文案，对应第三个 step 的完整口播内容
...
| 动画指令 | `**动画**:` 紧跟在每段 `>` 字幕之后，描述该 step 画面上的变化 |
...
| 字幕段落超过 80 字 | 拆分为多段，每段 30-80 字，对应一个 step |
